...
public class NumsServiceLocator extends org.apache.axis.client.Service implements co.edureka.NumsService {
    ...
    public co.edureka.Nums getNums() throws javax.xml.rpc.ServiceException {
    ...
    public co.edureka.Nums getNums(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.edureka.NumsSoapBindingStub _stub = new co.edureka.NumsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.edureka.Nums.class.isAssignableFrom(serviceEndpointInterface)) {
                co.edureka.NumsSoapBindingStub _stub = new co.edureka.NumsSoapBindingStub(new java.net.URL(Nums_address), this);
                _stub.setPortName(getNumsWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://edureka.co", "NumsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://edureka.co", "Nums"));
        }
